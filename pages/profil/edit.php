...
if (!$data) {
    echo "<div style='text-align:center; margin-top:40px;'><h3>Data profil tidak ditemukan!</h3><a href='/poin_siswa/pages/dashboard.php'>Kembali ke Dashboard</a></div>";
} else {
?>
...
<center>
    ...
    <form method="POST" action="/poin_siswa/process/profil_process.php">
