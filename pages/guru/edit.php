...
if (!$data) {
    echo "<div style='text-align:center; margin-top:40px;'><h3>Data guru tidak ditemukan!</h3><a href='list.php'>Kembali</a></div>";
} else {
    ?>
    ...
    <center>
        <form method="POST" action="../../process/guru_process.php">
