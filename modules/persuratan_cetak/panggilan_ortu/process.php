...
// Format tanggal
$tanggal_formatted = tanggal_indonesia($tanggal);
...
if(mysqli_num_rows($cek_surat) == 0) {
    mysqli_query($conn, "INSERT INTO surat_keluar (no_surat, id_tingkat, jenis_surat, nis, tanggal_pembuatan_surat) VALUES ('$no_surat', '$id_tingkat', 'panggilan', '$nis', '$tgl_sekarang')");
}
