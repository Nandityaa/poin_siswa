...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if($action == 'add'){
        ...
        if($query){
            echo "<script>alert('Berhasil Menambah Data Jenis Pelanggaran'); window.location.href = 'index.php';</script>";
        }else{
            echo "<script>alert('Gagal Menambah Data Jenis Pelanggaran'); window.location.href = 'create.php';</script>";
        }
    }
    ...
    if($action == 'edit'){
        ...
        if($query){
            echo "<script>alert('Berhasil Mengubah Data Jenis Pelanggaran'); window.location.href = 'index.php';</script>";
        }else{
            echo "<script>alert('Gagal Mengubah Data Jenis Pelanggaran'); window.location.href = 'index.php';</script>";
        }
    }
    ...
    if($action == 'delete'){
        ...
        if($query){
            echo "<script>alert('Berhasil Menghapus Data Jenis Pelanggaran'); window.location.href = 'index.php';</script>";
        }else{
            echo "<script>alert('Gagal Menghapus Data Jenis Pelanggaran'); window.location.href = 'index.php';</script>";
        }
    }
