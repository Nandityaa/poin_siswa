        ...
        <div class="form-body">
            <form action="/poin_siswa/modules/jenis_pelanggaran/process.php" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="nama_pelanggaran" class="form-control" autocomplete="off" required placeholder="Contoh: Terlambat Masuk Kelas" />
                </div>

                <div class="form-group">
                    <label class="form-label">Poin Pelanggaran <span style="color:red;">*</span></label>
                    <input type="number" name="poin" class="form-control" autocomplete="off" required placeholder="Contoh: 10" />
                </div>
